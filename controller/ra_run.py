...
from ra_manager import RaManager
...
if __name__ == '__main__':
	testbed = default_testbed (ip='192.168.1.10', dir_name=dirName, manager_class=RaManager)
	...
	en = testbed.add_emulated_node (name='n1', working_dir='/home/worker/dml_app',
		cmd=['python3', 'ra_peer.py'], image='dml:v1.0', cpu=4, ram=4, unit='G', emulator=emu1)
	...
	for i in range (2, 5):
		en = testbed.add_emulated_node ('n' + str (i), '/home/worker/dml_app',
			['python3', 'ra_peer.py'], 'dml:v1.0', cpu=1, ram=2, unit='G', emulator=emu2)
	...
	p1.set_cmd (working_dir='dml_app', cmd=['python3', 'ra_peer.py'])
